...
async def create_journal_entry_excel(journal_entry: JournalEntry) -> PlanarFile:
    ...
    try:
        ...
        summary.write('B4', journal_entry.entry_date, date_format)
        ...
        summary.write('B10', 'Yes' if journal_entry.is_balanced else 'No', balanced_format)
        ...
        # Write headers
        headers = [
            "Entry Date", "Invoice Number", "Vendor", "Description",
            "Account Name", "Debit", "Credit", "Line Memo", 
            "Entry Total", "Balanced?"
        ]
        ...
        for line in journal_entry.lines:
            detail.write(row, 0, journal_entry.entry_date, date_format)
            ...
            detail.write(row, 9, 'Yes' if journal_entry.is_balanced else 'No', balanced_format)
            row += 1
